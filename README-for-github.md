...
## Recent drip essays (cycle output, newest first)

Each essay below is a public finding from the corpus that also stands alone as an operator-grade read. The full citation set for each lives in the published essay.

- **26 May 2026 —** [When the agencies write their own rankings.](https://northpoint.fi/resources/writing/when-agencies-write-their-own-rankings) The vendor-authored 2026 agency rankings are funnels, not rankings. The buyer-side question is one layer up.
- **25 May 2026 —** [Three on the grid, zero on the leaderboard.](https://northpoint.fi/resources/writing/three-on-the-grid-zero-on-the-leaderboard) The 2026 F1 sponsor grid (Kraken + Bitget at Williams, Gate.io at Red Bull) is the inverse of the global exchange leaderboard. Brand-partnership budget has redistributed.
- **21 May 2026 —** [The brand-partnership seat just changed hands.](https://northpoint.fi/resources/writing/the-brand-partnership-seat-just-changed-hands) Hiring data confirms the seat is moving down-market from the top three exchanges to the challenger tier.
- **20 May 2026 —** [Three empty chairs, sixty days.](https://northpoint.fi/resources/writing/three-empty-chairs-sixty-days) Conlan (Binance), Kalifowitz (Crypto.com), and a Coinbase reorg all converge inside one 60-day window.
- **19 May 2026 —** [The interim CMO is the new permanent CMO.](https://northpoint.fi/resources/writing/the-interim-cmo-is-the-new-permanent-cmo) Two Tier-1 interim-CMO announcements in one week is a category signal, not a coincidence.
- **18 May 2026 —** [Binance just put a product CEO in the CMO seat. The seat just changed shape.](https://northpoint.fi/resources/writing/binance-product-ceo-cmo-seat) Eowyn Chen's interim brief reframes what "marketing" means at exchange scale.

Older essays from the cycle (May 6 cycle-opener · May 7 Coinbase pod-model · May 11 $1B-CMO-era · May 12 Ritson · May 13 Binance-lost-its-CMO · May 14 sport-celeb · May 15 bridge-CMO) are indexed at [northpoint.fi/resources](https://northpoint.fi/resources).
...
- Email: [hello@northpoint.fi](mailto:hello@northpoint.fi) (nominations) · [jukka.blomberg@outlook.com](mailto:jukka.blomberg@outlook.com) (direct)
